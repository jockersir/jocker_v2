...
module.exports = {
    ...
    SESSION: process.env.JOKER_CODE === undefined ? '' : process.env.JOKER_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.hizliresim.com/loUtAb.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVEBTN: process.env.ALIVE_BUTTON === undefined ? 'ᴊᴏᴋᴇʀsᴇʀ🥂' : process.env.ALIVE_BUTTON,
    ...
    AFPLK: process.env.JOCKER_PASSWORD === undefined ? false : process.env.JOCKER_PASSWORD,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ 💝 jocker_V2 💝 ‒‒‒⊣' : process.env.BOT_NAME,
